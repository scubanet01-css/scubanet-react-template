export const GENERAL_TERMS_VERSION = "general-2014-12-19";

export const generalTermsTitle = "국외여행표준약관";

export const generalTermsText = `국외여행표준약관

표준약관 제10021호 【2014. 12. 19. 개정】

국외 여행업을 영위하는 여행업자(이하 갑이라 한다)와 국외여행을 하고자 하는 여행자(이하 을 이라 한다)는 국외여행에 관하여 다음과 같이 계약을 체결한다.

제1조(목적): 이 약관은 ‘(주)스쿠버넷트레블’과 여행자가 체결한 국외여행계약의 세부 이행 및 준수사항을 정함을 목적으로 합니다.
...
제18조(설명의무): 여행사는 계약서에 정해져 있는 중요한 내용 및 그 변경사항을 여행자가 이해할 수 있도록 설명하여야 합니다.
